...
public class ShaderPrograms {
    ...
    public static final ShaderProgram STANDARD_SHADER_PROGRAM = Registries.register(Registries.SHADER_PROGRAM, "standard_shader", new StaticShaderProgram("src/shader/VertexShader.glsl", "src/shader/FragmentShader.glsl"));
