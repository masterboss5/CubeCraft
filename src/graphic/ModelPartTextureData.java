...
public record ModelPartTextureData(
        Texture top,
        long topPointer,
        Texture bottom,
        long bottomPointer,
    ...
    public ModelPartTextureData(Texture texture) {
        this(texture, texture, texture, texture, texture, texture);
    }

    public ModelPartTextureData(Texture top, Texture bottom, Texture front, Texture back, Texture left, Texture right) {
