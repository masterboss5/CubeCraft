...
public class JsonLoader {
    ...
    public static BlockModel readBlockModelJSON(String fileName) {
        ...
        return ModelBuilder.buildBlockModel(Registries.SHADER_PROGRAM.get(readBlockModel.shader_program()), readBlockModel.vertices(), readBlockModel.indices(), readBlockModel.uv());
    }
}
